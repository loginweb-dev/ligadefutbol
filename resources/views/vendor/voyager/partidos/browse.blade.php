...
@section('page_header')
    <div class="container-fluid">
        ...
        @can('delete', app($dataType->model_name))
            ...
            {{-- <p>Eliminados</p> --}}
            {{-- Elimnados --}}
            {{-- <input type="checkbox" @if ($showSoftDeleted) checked @endif id="show_soft_deletes" data-toggle="toggle" data-on="TODOS" data-off="BORRADOS"> --}}
            @endif
        @endcan
                            ...
                            <form method="get" class="form-search">
                                <div id="search-input">
                                    <div class="col-2" hidden>
                                        <select id="se arch_key" name="key" hidden="hidden">
                                    ...
                                    <div class="col-2" hidden>
                                        <select id="filter" name="filter" hidden="hidden">
